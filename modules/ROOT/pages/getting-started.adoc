...
The “Open with” option should show “Discover (default)”.
...
To start the installation of the Flathub repository, click on the “Install” button (1).
You will need to authenticate in the following window to proceed with the installation.
...
This can be done directly from the Discover app, or apps can be browsed on the https://flathub.org/home[Flathub website].

If you choose to install apps from the Flathub website, clicking "Install" will download a file which will be opened by the Discover app, which can then be used to install the app.
For example, to install https://www.libreoffice.org/[LibreOffice], you first search for and open the LibreOffice page, and then press the “Install” button.
...
Once the Flatpak is downloaded, the Discover application will open a new window with an “Install” button.
