...
As an immutable host, Kinoite is an excellent platform for container-based
development and, for working with containers, https://buildah.io/[buildah] and
https://podman.io/[podman] are recommended.

Kinoite also comes with the https://github.com/containers/toolbox[toolbox]
...
https://kinoite.fedoraproject.org/[Fedora Kinoite], it provides a familiar
...
Toolbox is preinstalled on Fedora Kinoite.
